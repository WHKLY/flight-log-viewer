...
try:
    from scripts.mavlink_frames import MAVLINK_MESSAGE_NAMES, iter_mavlink_frames
except ModuleNotFoundError:  # pragma: no cover - direct script execution.
    from mavlink_frames import MAVLINK_MESSAGE_NAMES, iter_mavlink_frames
...
MISSION_MESSAGE_IDS = {39, 40, 41, 42, 43, 44, 45, 46, 47, 51, 73}
...
def extract_tlog_mission(path: Path | None, modes: dict[str, Any]) -> dict[str, Any] | None:
    ...
    for frame in iter_mavlink_frames(path, MISSION_MESSAGE_IDS):
        name = frame["name"]
